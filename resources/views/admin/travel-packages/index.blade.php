...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Manage Tour</h1>
            <a href="{{ route('admin.travel-packages.create') }}" class="btn btn-primary btn-sm shadow-sm">Add Tour Travel  <i class="fa fa-plus"> </i></a>
    </div>
